	...
	<html>
	<head>
	<title>modify form to accept  4 different payment levels - ScriptLance Programming Project</title>
	<!-- My site prbot.com has paid plan that uses paypal button. The plan in this place has more fields than I need. It already interacts with admin to create a Press release that gets published. I would like... PHP/MySQL Project posted on ScriptLance. -->
	<meta name="description" content="My site prbot.com has paid plan that uses paypal button. The plan in this place has more fields than I need. It already interacts with admin to create a Press release that gets published. I would like... PHP/MySQL Project posted on ScriptLance.">
...
<table width="100%"cellpadding=0 cellspacing=0><tr><td valign=top><b><big>modify form to accept  4 different payment levels</big></b>  <img src="https://www.scriptlance.com/programmers/graphics/urgent.gif" alt="Urgent!" width=56 height=14 border=0>
 <a href="/prepaid.shtml"><img src="/images/prepaid.gif" border=0 width=54 height=12 alt="Pre-Paid" title="Pre-Paid Project"></a></td><td valign=top align=right width=140><a href="https://www.scriptlance.com/cgi-bin/freelancers/buyers.cgi?new=project&clone=1284568693"><img src="/images/similar_project.gif" width=137 height=19 border=0 alt="Post Similar Project"></a></td><td valign=top align=right width=82><A HREF="https://www.scriptlance.com/cgi-bin/freelancers/project.cgi?bookmark=1284568693"><IMG SRC="/images/bookmark.gif" WIDTH="79" HEIGHT="19" BORDER="0" title="Bookmark Project" alt="Bookmark Project"></a></td><td valign=top align=right width=69><A HREF="https://www.scriptlance.com/cgi-bin/freelancers/project.cgi?manage_project=1284568693"><IMG SRC="/images/manage.gif" WIDTH="66" HEIGHT="19" BORDER="0" title="Manage Your Project" alt="Manage Your Project"></a></td><td valign=top align=right width=22><A HREF="https://www.scriptlance.com/cgi-bin/freelancers/freelancers.cgi?user_lists_favorite_add=msmark&return=http://www.scriptlance.com/projects/1284568693.shtml" onmouseover="document.addfav.src='/images/favorite.png'" onmouseout="document.addfav.src='/images/favorite_grey.png'"><IMG SRC="/images/favorite_grey.png" WIDTH="19" HEIGHT="19" BORDER="0" title="Add To Favorites" name="addfav"></a></td>
<td valign=top align=right width=21><A HREF="https://www.scriptlance.com/cgi-bin/freelancers/freelancers.cgi?user_lists_ban_add=msmark&return=http://www.scriptlance.com/projects/1284568693.shtml" onmouseover="document.addban.src='/images/blacklist.png'" onmouseout="document.addban.src='/images/blacklist_grey.png'"><IMG SRC="/images/blacklist_grey.png" WIDTH="19" HEIGHT="19" BORDER="0" title="Blacklist User" name="addban"></a></td>
	<td valign=top align=right width=21><A HREF="https://www.scriptlance.com/cgi-bin/freelancers/report_violation.cgi?t=p&pid=1284568693" onmouseover="document.reportproject.src='/images/report_red.gif'" onmouseout="document.reportproject.src='/images/report.gif'"><IMG SRC="/images/report.gif" WIDTH="19" HEIGHT="19" BORDER="0" title="Report Project Violation" name="reportproject"></a></td></tr>	
	</table>
	<table cellspacing=0 cellpadding=0 width="100%">
		<tr>
		...
		<tr>
		<td><b>Project ID:</b> 1284568693</td>
		<td align=right>
...
function ajax_async(url,callbackfuncname)
{
	...
	<table width="100%" cellpadding=0 cellspacing=0>
		...
		<td align=right>
			...
			<tr>
				<td width=150><a href="https://www.scriptlance.com/cgi-bin/freelancers/project_review.cgi?id=1284568693"><img src="/images/project_review_left.gif" width=150 height=19 border=0 title=""></a></td>
	...
	<img border="0" src="/images/rate_staror.png" id="1284568693-1" onmouseover="MouseOver(this)" onmouseout="MouseOut(this)" onclick="SendRating(this)" style="cursor:pointer;"><img border="0" src="/images/rate_staror.png" id="1284568693-2" onmouseover="MouseOver(this)" onmouseout="MouseOut(this)" onclick="SendRating(this)" style="cursor:pointer;"><img border="0" src="/images/rate_staror.png" id="1284568693-3" onmouseover="MouseOver(this)" onmouseout="MouseOut(this)" onclick="SendRating(this)" style="cursor:pointer;"><img border="0" src="/images/rate_staror.png" id="1284568693-4" onmouseover="MouseOver(this)" onmouseout="MouseOut(this)" onclick="SendRating(this)" style="cursor:pointer;"><img border="0" src="/images/rate_staror.png" id="1284568693-5" onmouseover="MouseOver(this)" onmouseout="MouseOut(this)" onclick="SendRating(this)" style="cursor:pointer;"></td></tr></table>
			</td>
			<td width=4 background="/images/project_review_bg.gif"></td>
			<td background="/images/project_review_bg.gif"><a href="https://www.scriptlance.com/cgi-bin/freelancers/project_review.cgi?id=1284568693" style="text-decoration:none">Comments (0)</a></td>
			<td width=4 background="/images/project_review_bg.gif"></td>
...
<td style="padding:4" class=dt2 valign=top><b>Bidding Ends:</td>
	<td style="padding:4" class=dt2 valign=top>
	9/18/2010 at 12:38 EST <font color=red>(2 days left)</font>
</td>
</tr>
...
<td style="padding:4" class=dt1 valign=top>
	<table cellspacing=0 cellpadding=0><tr><td><a href="https://www.scriptlance.com/cgi-bin/freelancers/buyers.cgi?view=msmark">msmark</a>   </td></tr>
		<tr><td height=2></td></tr>
		<tr><td><small>Rating:
	<a href="https://www.scriptlance.com/cgi-bin/freelancers/feedback.cgi?w=msmark"><img src="https://www.scriptlance.com/images/rating_10.gif" border=0 alt="10.00/10" title="10.00/10" width=81 height=7></a> <a href="https://www.scriptlance.com/cgi-bin/freelancers/feedback.cgi?w=msmark">(<b>1</b> review)</a>
</td></tr>
	</table></td>
</tr>
...
1)I want to make it so it accepts payment with ejunkie buttons with 4 price points. <br>
<br>
$25 for 1 release<br>
$49 for 3 for the month<br>
$69 for up to 5  unlimited PRs for the  month<br>
$99 for unlimited prs for the  month.<br>
<br>
2)<br>
The site should accomodate above and allow only set amount of releases per month based on point (or unlimited). <br>
<br>
3)It will also block multiple company names used on each release so user can only make releases for one company and not many. With each plan purchased it must all be used for same company.<br>
<br>
4)I want the amount of releases per month for each plan level to be editable. I can edit price in ejunkie admin.<br>
<br>
5)You will make current user admin area show  how many releases they have remaining. With option to renew or upgrade or downgrade.<br>
<br>
6) All featured releases will display in new area on top of free releases you create called featured press releases.<br>
<br>
7) Admin will be notified of all paid releases via email<br>
<br>
8) Admin will have option to approve releases before going live ( site now has option to set delay on when published).<br>
<br>
9) I would like RSS feed made with just the featured releases.<br>
<br>
- Make following edits on site. <br>
10) Make search box on see all press releases page be same as homepage search box.<br>
<br>
11) make grean box highlighting page views accomodate 3 digit numbers. These are on home page and see all press releases page. <br>
...
<td style="padding:4" class=dt1 valign=top>
<table width="100%" cellspacing=0 cellpadding=0 border=0><tr><td valign=top><a href="/tag/PHP" style="text-decoration: none">PHP</a>, <a href="/tag/MySQL" style="text-decoration: none">MySQL</a>, <a href="/tag/Modification" style="text-decoration: none">Modification</a>, <a href="/tag/Form" style="text-decoration: none">Form</a>, <a href="/tag/Payment" style="text-decoration: none">Payment</a></td><td width=47 align=right valign=top><a href="https://www.scriptlance.com/cgi-bin/freelancers/project.cgi?project_tags_edit=1284568693"><img src="/images/edit_small.png" border=0 width=42 height=13 title="Change Tags"></a> </td></tr></table></td>
</tr>
...
<br><br>
<table><tr>
	<td><a href="https://www.scriptlance.com/cgi-bin/freelancers/forum.cgi?viewsub=1284568693"><img src="https://www.scriptlance.com/programmers/graphics/viewboard.gif" border=0 alt="View Message Board for this Project"></a></td>
	<td width=10></td>
	<td>Messages Posted: <b>1</b></td>
	</tr>
</table>
<br><br>
<a name="bids"></a>
...
<a href="https://www.scriptlance.com/cgi-bin/freelancers/project.cgi?bid=1284568693"><img src="https://www.scriptlance.com/programmers/graphics/placebid.gif" border=0 alt="Place Bid"></a>
</td></tr>
</table>
...
<tr>
<td width=2 bgcolor="#FF9E2C"></td>
<td style="padding:4" class=dt><a href="https://www.scriptlance.com/cgi-bin/freelancers/project.cgi?id=1284568693&order=username%20ASC#bids" style="text-decoration: none">Programmers</font></a></td>
<td style="padding:4" class=dt><a href="https://www.scriptlance.com/cgi-bin/freelancers/project.cgi?id=1284568693&order=bid%20DESC#bids" style="text-decoration: none">Bid <img src="/programmers/graphics/arrow.gif" width=12 height=9 border=0></font></a></td>
<td style="padding:4" class=dt><a href="https://www.scriptlance.com/cgi-bin/freelancers/project.cgi?id=1284568693&order=days%20ASC#bids" style="text-decoration: none">Delivery Time</font></a></td>
<td style="padding:4" class=dt><a href="https://www.scriptlance.com/cgi-bin/freelancers/project.cgi?id=1284568693&order=time%20ASC#bids" style="text-decoration: none">Time of Bid</font></a></td>
<td style="padding:4" class=dt align=center><a href="https://www.scriptlance.com/cgi-bin/freelancers/project.cgi?id=1284568693&order=b.rating%20DESC#bids" style="text-decoration: none">Rating</font></a></td>
<td style="padding:4" width=13 class=dt>&nbsp;</td>
<td width=19 style="padding:4" class=dt>&nbsp;</td>
</tr>
<tr><td width=2 bgcolor="#FF9E2C" height=1></td><td style="padding:4" class=dt1 colspan=8><br><center>(5 bids have been placed. msmark has chosen to keep all bids for this project hidden.)<br><br></td></tr><tr><td width=2 bgcolor="#FF9E2C" height=1></td><td class=dt colspan=8 height=1></td></tr></table>
<p>
<a href="https://www.scriptlance.com/cgi-bin/freelancers/project.cgi?bid=1284568693"><img src="https://www.scriptlance.com/programmers/graphics/placebid.gif" border=0 alt="Place Bid"></a>
<br><br>
<br>
		...
		<td width=2 bgcolor="#FF9E2C"></td><td class=dt1 width=5></td><td class=dt1 width=100><b>Related Projects:</b> </td><td class=dt1>
			<table width="100%"><tr>
			<td width="20%" align=center><a href="http://www.scriptlance.com/projects/1284476274.shtml">levels indikator</a></td>
			<td width="20%" align=center><a href="http://www.scriptlance.com/projects/1283372350.shtml">Twitter Utility with two levels of detail</a></td>
			<td width="20%" align=center><a href="http://www.scriptlance.com/projects/1284564421.shtml">Payment System</a></td>
			<td width="20%" align=center><a href="http://www.scriptlance.com/projects/1283436870.shtml">I need the payment module completed on my website 2</a></td>
			<td width="20%" align=center><a href="http://www.scriptlance.com/projects/1284486770.shtml">add pagseguro payment gateway to my script</a></td>
			</tr></table>
		</td><td class=dt1 width=50><a href="http://www.scriptlance.com/cgi-bin/freelancers/search.cgi?keywords=modify+or+form+or+to+or+accept+or+4+or+different+or+payment+or+levels&showstatus=open&desc=1">More...</a></td>
		</tr>
		<tr><td width=2 bgcolor="#FF9E2C" height=1></td><td class=dt colspan=4 height=1></td></tr>
		</table>
		<br><br>
